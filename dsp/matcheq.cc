...
private:
	...
	inline double power2db(double power,double old_power);
...
#define bypass (*bypass_)
	...
	fVbargraph0 = (bypass? FAUSTFLOAT(20.*log10(_power0)) : db_zero);
	fVbargraph1 = (bypass? FAUSTFLOAT(20.*log10(_power1)) : db_zero);
	fVbargraph2 = (bypass? FAUSTFLOAT(20.*log10(_power2)) : db_zero);
	fVbargraph3 = (bypass? FAUSTFLOAT(20.*log10(_power3)) : db_zero);
	fVbargraph4 = (bypass? FAUSTFLOAT(20.*log10(_power4)) : db_zero);
	fVbargraph5 = (bypass? FAUSTFLOAT(20.*log10(_power5)) : db_zero);
	fVbargraph6 = (bypass? FAUSTFLOAT(20.*log10(_power6)) : db_zero);
	fVbargraph7 = (bypass? FAUSTFLOAT(20.*log10(_power7)) : db_zero);
	fVbargraph8 = (bypass? FAUSTFLOAT(20.*log10(_power8)) : db_zero);
	fVbargraph9 = (bypass? FAUSTFLOAT(20.*log10(_power9)) : db_zero);
	fVbargraph10 = (bypass? FAUSTFLOAT(20.*log10(_power10)) : db_zero);
